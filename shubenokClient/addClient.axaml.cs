...
public partial class AddClient : Window
{
    ...
    public AddClient()
    {
      ...
      //  phoneMask.SelectionChanged += PhoneMask_SelectionChanged;
      //  regexTelephone = new Regex(@"^[7](\d{2})\d{3}(-\d{2}){2}$");
    }

   /* private void PhoneMask_SelectionChanged1(object? sender, SelectionChangedEventArgs e)
    {
